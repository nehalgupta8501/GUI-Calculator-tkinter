...
window.resizable(0,0) #to prevent resizing of window
...
#first row will have the clear button and divide button
...
#fifth row will comprise of the buttons '0', 'Decimal (.)', and 'Equal To (=)'
